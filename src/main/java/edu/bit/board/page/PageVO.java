...
public class PageVO {
    ...
    private int endPage; // 페이지목록 끝번호
    private boolean prev, next; // 페이지목록 이전, 다음으로 이동 가능한 링크 표시
    ...
    public PageVO(Criteria cri, int total) {
        ...
        // ceil -> 올림
        this.startPage = this.endPage - 9; // 10페이지 기준

        // total을 통한 endPage의 재 계산
        // 페이지 목록을 10개씩 보여주는 경우,
        // 전체 데이터 수가 80개라고 가정하면
        // 페이지 목록의 끝번호는 10이 아닌 8이 됨
